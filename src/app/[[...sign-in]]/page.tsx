...
const LoginPage = () => {
  ...
  return (
    <div className='h-screen flex items-center justify-center bg-lightorange'>
        <SignIn.Root>
    ...
    <h2 className="text-darkgray">Sign in to your account</h2>
    ...
    <SignIn.Action submit className="bg-orange text-white my-1 rounded-md text-sm p-[10px]">Sign in</SignIn.Action>
            </SignIn.Step>
        </SignIn.Root>
    </div>
  )
